package com.unit09.string_class.bufferandbuilder;
...
//        s1.insert(2,false);
//        s1.reverse();
        String s2 = s1.substring(1, 3);//左开右闭
        System.out.println(s1);
